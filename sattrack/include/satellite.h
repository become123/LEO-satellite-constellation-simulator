...
public: 
    ...
    int judgeRightConnectability(int second, const AER &acceptableAER_diff);
    ...
    int judgeLeftConnectability(int second, const AER &acceptableAER_diff);
    ...
    int judgeFrontConnectability(int second, const AER &acceptableAER_diff);
    ...
    int judgeBackConnectability(int second, const AER &acceptableAER_diff);
    ...
    int judgeRightISL(int second, const AER &acceptableAER_diff);

    //回傳特定時刻可否建立左方的ISL(要彼此可以連線到彼此才可以建立)
    int judgeLeftISL(int second, const AER &acceptableAER_diff);

    std::bitset<86400> getRightISLstates(int PATtime, const AER &acceptableAER_diff);

    std::bitset<86400> getLeftISLstates(int PATtime, const AER &acceptableAER_diff);
